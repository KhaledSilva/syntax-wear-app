    ...
    <section className="flex flex-col md:flex-row items-center md:h-screen">
      ...
      <div className="text-black px-8 py-16 lg:px-20 md:w-1/2 h-full flex flex-col justify-center">
        ...
        <p className="text-text-secondary text-lg leading-relaxed mb-5">
          ...
          oferencendo uma experiência de compra incrível e uma seleção de tênis,
          botas e sapatos para todas as ocasiões.
        </p>

        <Link
          to="/our-stores"
          className="self-start text-xs font-bold text-[#333333] uppercase border-b-2 tracking-[0.2em] hover:text-accent transition-colors duration-500"
        >
